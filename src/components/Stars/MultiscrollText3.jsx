...
function MultiscrollText3(props) {
...
<div  className="relative mr-[30px]   flex flex-col items-center justify-center w-full text-center text-white BGB text-3xl  lg:text-6xl z-50 uppercase ">
  {/* <div className="mt-10"> */}
...
export default MultiscrollText3;
