...
const Nduty = () => {
  return (
    <div className="">
      <div className="">
        <div className="text-4xl font-semibold mb-10 lg:mt-16 mt-5 mr-5 text-center lg:text-left text-[#F74061]">
          Responsibilities as Campus Ambassador
        </div>
        <div className="flex flex-col-reverse lg:flex-row">
          <div className="lg:mt-0 mt-5 mr-5 lg:mr-0 mb-20 lg:mb-0 lg:w-[45%] font-semibold">
            <div>
