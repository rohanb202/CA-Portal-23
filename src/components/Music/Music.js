...
export default function Music(){
  ...
  function closeModal() {
    ...
    return(
        <>
        <div className={MusicCss.mobilenav}>
          <i className="bg-gray-300 fa fa-bars" aria-hidden="true"></i>
          <button onClick={showNav}></button>
          <img src={kylogo} alt="ky-23"></img>
        </div>
        <div id="mobilenavdropdown" className={MusicCss.mobilenavdropdown}>
          <button onClick={closeNav} className={MusicCss.backicon}></button>
          <div className={MusicCss.title}>
            <img src={kylogo} alt="kashiyatra"></img>
          </div>
          <ul className={MusicCss.nav}>
            <li>
              <Link to="/">TEAM</Link>
            </li>
            <li>
              <Link to="/Music">EVENTS</Link>
            </li>
            <li>
              <Link to="/">FAQ</Link>
            </li>
        ...
        <div className={MusicCss.outernav}>
          <div className={MusicCss.navbar}>
            <Link to="/">
              <div className={MusicCss.kylogo}></div>
            </Link>
            <div className={MusicCss.navlist}>
              <ul className={MusicCss.navlistul}>
                <li className={MusicCss.navitem}>
                  <Link to="/">TEAM</Link>
                </li>
                <li className={MusicCss.navitem}>
                  <Link to="/Music">EVENTS</Link>
            ...
            <div className={MusicCss.kyprofile}></div>
          </div>
        </div>
       <Nav />
        <div className={MusicCss.MusicColumns}>
        <div className={MusicCss.MusicCard} >
        <img className="w-full" src={img1} alt="Sunset in the mountains" />
        <div className="mt-1 text-white" style={{backgroundColor:"#F74061"}}>
            <div className="font-bold text-xl mb-2 mt-2" style={{color:"#06122E"}}>{eventData.Music[0].eventName}</div>
            <div className="font-bold text-xl mb-2" style={{color:"#06122E"}}>3 PM, Friday</div>
            <div className={MusicCss.eventCardBorder}></div>
...
<div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto "
  ...
  <div class="modal-dialog relative w-auto pointer-events-none ">
    <div
      ...
      <div className={MusicCss.eventCardExpandedBorder}>
          <div>
            <div className={MusicCss.eventCardTitle}>{eventData.Music[0].eventName}</div>
            <div className={MusicCss.eventCardTitle}>3 PM, Friday</div>
          </div>
          <div className="flex items-center justify-center mt-5 mb-5">
            <button className={MusicCss.MusicCardButton}>
            Register
            </button>
          </div>
      </div>
      <p className={MusicCss.eventCardInsideText}>
        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatibus quia, nulla! Maiores et perferendis eaque, exercitationem praesentium nihil.
        ...
        <img className="w-full" src={img1} alt="Sunset in the mountains" />
        <div className="mt-1 text-white" style={{backgroundColor:"#F74061"}}>
            <div className="font-bold text-xl mb-2 mt-2" style={{color:"#06122E"}}>{eventData.Music[1].eventName}</div>
            <div className="font-bold text-xl mb-2" style={{color:"#06122E"}}>3 PM, Friday</div>
            <div className={MusicCss.eventCardBorder}></div>
            <p className="text-base text-white mt-3 text-md " style={{color:"#06122E"}}>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatibus quia, nulla! Maiores et perferendis eaque, exercitationem praesentium nihil.
...
<div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto "
  ...
  <div class="modal-dialog relative w-auto pointer-events-none ">
    <div
      ...
      <div className={MusicCss.eventCardExpandedBorder}>
          <div>
            <div className={MusicCss.eventCardTitle}>{eventData.Music[1].eventName}</div>
            <div className={MusicCss.eventCardTitle}>3 PM, Friday</div>
          </div>
          <div className="flex items-center justify-center mt-5 mb-5">
          <button className={MusicCss.MusicCardButton}>
      ...
      <p className={MusicCss.eventCardInsideText}>
        ...
        <img className="w-full" src={img1} alt="Sunset in the mountains" />
        <div className="mt-1 text-white" style={{backgroundColor:"#F74061"}}>
            <div className="font-bold text-xl mb-2 mt-2" style={{color:"#06122E"}}>Group Music</div>
            <div className="font-bold text-xl mb-2" style={{color:"#06122E"}}>3 PM, Friday</div>
            <div className={MusicCss.eventCardBorder}></div>
            <p className="text-base text-white mt-3 text-md " style={{color:"#06122E"}}>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatibus quia, nulla! Maiores et perferendis eaque, exercitationem praesentium nihil.
...
<div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto "
  ...
  <div class="modal-dialog relative w-auto pointer-events-none ">
    <div
      ...
      <div className={MusicCss.eventCardExpandedBorder}>
          <div>
            <div className={MusicCss.eventCardTitle}>Group Music</div>
            <div className={MusicCss.eventCardTitle}>3 PM, Friday</div>
          </div>
          <div className="flex items-center justify-center mt-5 mb-5">
