...
export default function FooterMain() {
  ...
  <div className={`${Footercss.column3} ${Footercss.column} `}>
    <h2 className={`${Footercss.font} ${Footercss.font3}`}>Get in Touch</h2>
    <div className={Footercss.image}>
      <span className={Footercss.row1}>
        ...
        <span className={Footercss.row2}>
        <div className={`${Footercss.row2} ${Footercss.ky}`}>ky@gmail.com</div>
        <div className={`${Footercss.row2} ${Footercss.ky}`}>9876543210</div>
        </span>
    </div>
  </div>
</div>
        <div className={Footercss.Lborder}></div>
        <img src={copy} alt="" className={Footercss.copyright} />
      </div>
    </div>
  );
}
