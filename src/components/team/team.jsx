      ...
      <section class="content-center">
        <div class="content-center px-6 py-10 mx-auto">
          ...
          <div class="content-center grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-3 ">
            {/* <div class="bg-white flex flex-col items-center p-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-blue-600 dark:border-gray-700 dark:hover:border-transparent">
              <img
              ...
              <div class="mt-4 text-2xl text-black-500 capitalize group-hover:text-white">
                Rohan Bhandari
              </div>
